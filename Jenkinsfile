    ...
    stages {
        ...
        stage("Build Package") {
            steps {
                ...
                bat(
                    "\"C:\\Program Files\\UiPath\\Studio\\UiPath.Studio.CommandLine.exe\" publish --project-path \"${WORKSPACE}\\project.json\" --target Custom --feed \"${WORKSPACE}\" --new-version \"1.0.88428421\""
                )
                // UiPathPack (
